...
source /dev/stdin <<< "$(curl -fsSL https://raw.githubusercontent.com/murdockcrc/dotfiles/mac/script/prompt)"
...
then
	...
	git clone https://github.com/murdockcrc/dotfiles.git ~/.dotfiles
	echo ''
	...
	echo ''
    echo "You chose not to apply the dotfiles. You will need to configure your environment manually..."
	echo ''
